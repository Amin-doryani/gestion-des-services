...
<div id="confirmationDialog">
    ...
    <div class="tablediv" >
        ...
        <table >
            ...
            <?php 
            $sql = "SELECT * FROM services  limit 8 ";
...
<script src='./javascript/serjs.js'>
